...
- Historical departure/arrival airports lag reality by at least a day and are frequently null. This is acceptable for an analytics/portfolio surface where the airports feed aggregate "busiest airports" and "top routes" charts over a 14 whole-UTC-day window ([ADR-013](013-analytics-presentation.md)), not a real-time operational display.
